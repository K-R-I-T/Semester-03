...
class PQHeap {
    ...
    public PQHeap() {heap=new int[MAX_SIZE]; size=0;}
    ...
    public void enqueue(int data) {
        if(size>=MAX_SIZE) {
            System.out.println("The queue is full. Cannot insert"); return;
        }
    ...
    public int dequeue() {
        ...
        heap[0] = heap[size-1]; size=size-1;
...
public class Main {
    public static void main(String [] args) {
        ...
        queue.enqueue(43); queue.enqueue(333); queue.enqueue(345);
        queue.enqueue(45); queue.enqueue(3); queue.enqueue(400);
